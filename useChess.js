...
* Nel name mi memorizzo la loro posizione x-z sulla scacchiera, mentre in id ho colore-posizione nell'array-pezzo */
	loader.load("D:/Simple-3D-Chess-master/models/wpawn.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/wrook.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/wknight.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/wbishop.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/wking.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/wqueen.js",function(geometry,materials) {
...
// Creo i pezzi neri, per cui vale quando detto per i bianchi
	loader.load("D:/Simple-3D-Chess-master/models/bpawn.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/brook.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/bknight.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/bbishop.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/bking.js",function(geometry,materials) {
	...
	loader.load("D:/Simple-3D-Chess-master/models/bqueen.js",function(geometry,materials) {
